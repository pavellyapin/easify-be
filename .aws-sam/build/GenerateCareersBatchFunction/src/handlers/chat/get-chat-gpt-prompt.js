const { getDataFromS3, getOpenAIObject, getChatGPTPrompt } = require('../utils');
...
exports.lambdaHandler = async (event) => {
    try {
        ...
        const gptResponse = await getChatGPTPrompt(openai, input.conversation,256,'gpt-3.5-turbo');
